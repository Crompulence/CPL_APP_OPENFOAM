...
if __name__ == '__main__':
    ...
    fdir = '/home/ezxgg4/simulations/ecseaf01/MDdata/'
    startrec = 455; endrec = 1600
    yloc = 32
    ...
    mdrec = startrec #-1
    ntimestep = (rhoObj.maxrec - startrec + 1)*timestepratio #added by me
